...
export default class Table<T extends ScalarDict> extends React.Component<
  Pick<TableProps<T>, "data"> &
    Partial<TableProps<T>> & { selectedIndex?: number }
> {
  /* Config */
          ...
          return (
            <Box flexDirection="column" key={key}>
              ...
              {this.data({
                ...
                columns,
                data: row,
                selected: this.props.selectedIndex === index ? true : undefined,
              })}
            </Box>
          );
        })}
      ...
      {...intersperse(
        ...
        props.columns.map((column, colI) => {
          ...
          if (value == undefined || value == null) {
            ...
            return (
              <config.cell selected={props.selected} key={key} column={colI}>
...
export function Cell(props: CellProps) {
  return (
    <Text color={props.selected ? "yellowBright" : undefined}>
      {props.children}
    </Text>
  );
}
